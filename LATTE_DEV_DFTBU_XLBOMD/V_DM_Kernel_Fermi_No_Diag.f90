subroutine V_DM_Kernel_Fermi_No_Diag(D_dq_v,DV,H0,mu0,mu1,T,RX,RY,RZ,LBox,Hubbard_U,Element_Type,Nr_atoms, &
...
real                        :: t1, t2
    ...
    do I = 1,Nr_atoms
      do K = H_INDEX_START(I),H_INDEX_END(I)
        dq_v(I) = dq_v(I) + 2*DV(K,K)
      enddo
    enddo

!!!
!    dq_v = ZERO
!    dq_v = dq_v/norm2(dq_v)
...
end subroutine V_DM_Kernel_Fermi_No_Diag
