...
SUBROUTINE ENTROPY
  ...
  REAL(LATTEPREC), ALLOCATABLE :: WORK(:), SEVEC(:,:), SEVAL(:)
  ...
  CHARACTER(LEN=1), PARAMETER :: JOBZ = 'N',  UPLO = 'L'
  ...
  ELSEIF (ENTROPYKIND .EQ. 1) THEN
     ...
     ALLOCATE(SEVEC(HDIM, HDIM), SEVAL(HDIM))
...
#ifdef DOUBLEPREC
        CALL DSYEV('N', 'U', HDIM, SEVEC, HDIM, SEVAL, WORK, LWORK,INFO)
#elif defined(SINGLEPREC)
        CALL SSYEV('N', 'U', HDIM, SEVEC, HDIM, SEVAL, WORK, LWORK,INFO)
#endif

#elif defined(XSYEVD)

#ifdef DOUBLEPREC
        CALL DSYEVD('N', 'U', HDIM, SEVEC, HDIM, SEVAL, WORK, LWORK, &
             IWORK, LIWORK, INFO)
#elif defined(SINGLEPREC)
        CALL SSYEVD('N', 'U', HDIM, SEVEC, HDIM, SEVAL, WORK, LWORK, &
             IWORK, LIWORK, INFO)
#endif
...
!           print*, occ
...
#ifdef DOUBLEPREC
        CALL DSYEV(JOBZ, UPLO, HDIM, SEVEC, HDIM, SEVAL, WORK, LWORK,INFO)
#elif defined(SINGLEPREC)
        CALL SSYEV(JOBZ, UPLO, HDIM, SEVEC, HDIM, SEVAL, WORK, LWORK,INFO)
#endif

#elif defined(XSYEVD)

#ifdef DOUBLEPREC
        CALL DSYEVD(JOBZ, UPLO, HDIM, SEVEC, HDIM, SEVAL, WORK, LWORK, &
             IWORK, LIWORK, INFO)
#elif defined(SINGLEPREC)
        CALL SSYEVD(JOBZ, UPLO, HDIM, SEVEC, HDIM, SEVAL, WORK, LWORK, &
             IWORK, LIWORK, INFO)
#endif
  ...
  ELSEIF (ENTROPYKIND .EQ. 2) THEN
     ...
     ALLOCATE(SEVEC(HDIM, HDIM), SEVAL(HDIM), WORK(LWORK))
