...
SUBROUTINE ADDDFTBU_INIT  ! ANDERS CHANGE 
  ...
  C_DFTB_U = 2.D0  ! I.E. NOT READ FROM FILE BUT DEFINED HERE
  ...
  enddo
  enddo
  write(*,*) ' SU(:) = ', SU(1,1:HDIM) 
  write(*,*) ' SU(:) = ', SU(2,1:HDIM) 
  ...
  enddo
  H = H + H_U
  write(*,*) ' adddftbu_init.f90 HU = ', HU(1,1:HDIM)
  write(*,*) ' adddftbu_init.f90 HU = ', HU(2,1:HDIM)
