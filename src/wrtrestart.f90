...
SUBROUTINE WRTRESTART(ITER)
  ...
  DO I = 1, NATS
     WRITE(21,14) ATELE(I), CR(1,I), CR(2,I), CR(3,I), DELTAQ(I)
  ENDDO
  ...
  IF (MDON .EQ. 1) THEN
     ...
     ENDDO
     WRITE(21,17) TOTE - KEE
     DO I = 1, NATS
        WRITE(21,15) FTOT(1,I), FTOT(2,I), FTOT(3,I)
     ENDDO
  ENDIF
  ...
  IF (MDON .EQ. 1) THEN
     ...
     DO I = 1, NATS
        WRITE(19,14) ATELE(I), CR(1,I), CR(2,I), CR(3,I), -DELTAQ(I)
     ENDDO
     ...
     ENDDO
     WRITE(19,17) TOTE - KEE
     DO I = 1, NATS
        WRITE(19,15) FTOT(1,I), FTOT(2,I), FTOT(3,I)
     ENDDO
     CLOSE(19)
