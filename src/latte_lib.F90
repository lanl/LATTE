...
!      WRITE(*,*)"STRESS_INOUT",-VIRIAL(1),-VIRIAL(2),-VIRIAL(3) 
  ...
  !!
  SUBROUTINE COMPUTE(COMPFLAG_IN,SY_IDX,NUM_SY,NCORES_IN,NCOREATOMS_IN,ETEMP_IN,CHEMPOT_IN,COULOMBV_IN,COORDS_IN,ATOMTYPES_IN,ATOMIC_NUMBERS_IN,LATTICE_VECTORS_IN,HAM_OUT,OVER_OUT,DM_OUT,CHARGES_OUT,EVALS_OUT,DVALS_OUT,ENERGY_OUT,FTOT_OUT,VERB_IN,NEWSYSTEM_IN,KEEPMEM_IN,EXISTERROR_INOUT)
