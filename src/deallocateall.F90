...
SUBROUTINE DEALLOCATEALL
  ...
  IF( ALLOCATED( BTYPE_INT )) DEALLOCATE( BTYPE_INT  )
  ...
  IF( ALLOCATED( d2PO )) DEALLOCATE( d2PO  )
  ...
  IF( ALLOCATED( SUMSPIN )) DEALLOCATE( SUMSPIN  )
  IF( ALLOCATED( DELTA_QS )) DEALLOCATE( DELTA_QS  )
  ...
  IF( ALLOCATED( OLDSUMSPIN )) DEALLOCATE( OLDSUMSPIN  )
  ...
  IF (ALLOCATED(DN2DT2)) DEALLOCATE(DN2DT2)
  IF (ALLOCATED(FULL_K)) DEALLOCATE(FULL_K)
  IF (ALLOCATED(FULL_K0)) DEALLOCATE(FULL_K0)
  IF (ALLOCATED(FULL_S)) DEALLOCATE(FULL_S)

  IF (ALLOCATED(FERMIOCC)) DEALLOCATE(FERMIOCC)
