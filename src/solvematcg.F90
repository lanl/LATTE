...
SUBROUTINE SOLVEMATCG
  ...
  REAL(LATTEPREC) :: R0VEC, P0VEC, R1VEC
  REAL(LATTEPREC) ::  XALPHA, XBETA
  IF (EXISTERROR) RETURN

  IF (SPINON .EQ. 0) THEN

     ! Let's try storing X2 in P0...

#ifdef DOUBLEPREC
     CALL DGEMM('N', 'N', HDIM, HDIM, HDIM, 1.0D0, &
          BO, HDIM, BO, HDIM, 0.0D0, P0, HDIM)
#elif defined(SINGLEPREC)
     CALL SGEMM('N', 'N', HDIM, HDIM, HDIM, 1.0, &
          BO, HDIM, BO, HDIM, 0.0, P0, HDIM)
#endif
...
#ifdef DOUBLEPREC
     CALL DGEMM('N', 'N', HDIM, HDIM, HDIM, 1.0D0, &
          A, HDIM, BO, HDIM, 0.0D0, R0, HDIM)
#elif defined(SINGLEPREC)
     CALL SGEMM('N', 'N', HDIM, HDIM, HDIM, 1.0, &
          A, HDIM, BO, HDIM, 0.0, R0, HDIM)
#endif
     ...
     DO WHILE (BREAKLOOP .EQ. 0)
        ...
        IF (ITER .EQ. 50) THEN
           CALL PANIC
           CALL ERRORS("solvematcg",'("SOLVEMATCG NOT CONVERGING")')
        ENDIF
  ...
  ELSE
...
#ifdef DOUBLEPREC
     CALL DGEMM('N', 'N', HDIM, HDIM, HDIM, 1.0D0, &
          RHOUP, HDIM, RHOUP, HDIM, 0.0D0, P0, HDIM)
#elif defined(SINGLEPREC)
     CALL SGEMM('N', 'N', HDIM, HDIM, HDIM, 1.0, &
          RHOUP, HDIM, RHOUP, HDIM, 0.0, P0, HDIM)
#endif
     ...
     DO WHILE (BREAKLOOP .EQ. 0)
        ...
        IF (ITER .EQ. 50) THEN
           CALL PANIC
           CALL ERRORS("solvematcg",'("SOLVEMATCG NOT CONVERGING: SPIN UP")')
        ENDIF
...
#ifdef DOUBLEPREC
     CALL DGEMM('N', 'N', HDIM, HDIM, HDIM, 1.0D0, &
          RHODOWN, HDIM, RHODOWN, HDIM, 0.0D0, P0, HDIM)
#elif defined(SINGLEPREC)
     CALL SGEMM('N', 'N', HDIM, HDIM, HDIM, 1.0, &
          RHODOWN, HDIM, RHODOWN, HDIM, 0.0, P0, HDIM)
#endif
     ...
     DO WHILE  (BREAKLOOP .EQ. 0)
        ...
        IF (ITER .EQ. 50) THEN
           CALL PANIC
           CALL ERRORS("solvematcg",'("SOLVEMATCG NOT CONVERGING: SPIN DOWN")')
        ENDIF
