...
SUBROUTINE SPINRHOEVECSPRG
  ...
  TYPE(BML_MATRIX_T) :: RHO_BML, AUX_BML, AUX1_BML, MYEVECS_BML, OCCUPATION_BML
...
!        print*, upne, downne, totne
  ...
  CALL BML_ZERO_MATRIX(BML_MATRIX_DENSE, BML_ELEMENT_REAL, &
       LATTEPREC, HDIM, HDIM, MYEVECS_BML)
  CALL BML_IMPORT_FROM_DENSE(BML_MATRIX_DENSE, &
            UPEVECS, MYEVECS_BML, ZERO, HDIM)

  CALL BML_MULTIPLY(MYEVECS_BML,OCCUPATION_BML,AUX_BML,1.0_dp,0.0_dp,NUMTHRESH)
  CALL BML_DEALLOCATE(OCCUPATION_BML)

  CALL BML_ZERO_MATRIX(BML_MATRIX_DENSE, BML_ELEMENT_REAL, &
       LATTEPREC, HDIM, HDIM, AUX1_BML)
  CALL BML_TRANSPOSE_NEW(MYEVECS_BML, AUX1_BML)
  CALL BML_DEALLOCATE(MYEVECS_BML) 
  ...
  CALL BML_ZERO_MATRIX(BML_MATRIX_DENSE, BML_ELEMENT_REAL, &
       LATTEPREC, HDIM, HDIM, MYEVECS_BML)
  CALL BML_IMPORT_FROM_DENSE(BML_MATRIX_DENSE, &
            DOWNEVECS, MYEVECS_BML, ZERO, HDIM)
