...
!!
SUBROUTINE MASSES2SYMBOLS(TYPES,NTYPES,MASSES_IN,NATSIN,SYMBOLS, Hubbard_U)
  ...
  INTEGER, INTENT(IN) :: TYPES(NATSIN)
  INTEGER, INTENT(IN) :: NATSIN
  REAL(8), INTENT(IN) :: MASSES_IN(NTYPES)
  CHARACTER(LEN=10), INTENT(INOUT) :: SYMBOLS(NATSIN)
  REAL(8), INTENT(out):: Hubbard_U(NATSIN)

  INTEGER :: NZ = 103
  CHARACTER(2), ALLOCATABLE :: ELEMENT_SYMBOL(:), TYPE_SYMBOLS(:)
  CHARACTER(20) :: DUMMYC1, DUMMYC2, DUMMYC3, DUMMYC4
  REAL(8), ALLOCATABLE :: ELEMENT_MASS(:)
  REAL(8), ALLOCATABLE :: ELEMENT_U(:)
  REAL(8) :: DUMMYR(20)
  CHARACTER(20) :: DUMMYC(20)
  REAL(8) :: DUMMYR1, DUMMYR2
  INTEGER :: I, J

  !> Read ptable
  !!
  OPEN(UNIT=14,STATUS="OLD", FILE="./TBparam/electrons.dat")
  !write(6,*) 'test-zy: entering mass2 symbol '

  ALLOCATE(ELEMENT_SYMBOL(NZ))
  ALLOCATE(ELEMENT_MASS(NZ))
  ALLOCATE(ELEMENT_U(NZ))

  READ(14,*) DUMMYC1, NZ
  READ(14,*) (DUMMYC(J),J=1,13)
  DO I = 1,NZ
     READ(14,*) ELEMENT_SYMBOL(I), DUMMYC1, (DUMMYR(J),J=1,5), ELEMENT_MASS(I), ELEMENT_U(I), (DUMMYR(J),J=6,9)
  ENDDO
