...
FUNCTION DFDBPREC(MYSLMMPL1, MYSLMMPL2, MYTMMPL1, MYTMMPL2, MYUNIVSCALE, I, J, L1, L2, M1, M2, R, ALPHA, COSBETA, WHICHINT)
  ...
  REAL(LATTEPREC) :: ALPHA, COSBETA, R, DFDBPREC
  ...
  DFDBPREC = TWO * AM(M1, ALPHA) * AM(M2, ALPHA) * &
  ...
  DO MP = 1, MIN(L1, L2)
     ...
     DFDBPREC = DFDBPREC + (DSLMMPDB(L1, M1, MP, ALPHA, COSBETA) * &
          MYSLMMPL2(MP) + &
          MYSLMMPL1(MP) * &
