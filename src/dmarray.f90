...
MODULE DMARRAY
  ...
  REAL(LATTEPREC), ALLOCATABLE :: POrth(:,:), DOrth(:,:), DELTAQDM(:), C_DFTB_U, EHub ! C_DFTB_U is the chosen Hubbard U for the DM term
  REAL(LATTEPREC), ALLOCATABLE :: DFTB_U(:), IXMAT(:,:), PS(:,:),SU(:,:), Delta_DS(:,:)
  REAL(LATTEPREC), ALLOCATABLE :: HubForce(:,:), DOrth_old(:,:)
