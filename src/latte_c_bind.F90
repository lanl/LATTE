...
SUBROUTINE LATTE_C_BIND (FLAGS, NATS, COORDS, TYPES, NTYPES, MASSES, XLO &
     ...
     VEL, DT, VIRIAL_INOUT, Q_OUT, NEWSYSTEM, EXISTERROR) BIND (C, NAME="latte")
  ...
  REAL(C_DOUBLE), INTENT(INOUT)  ::  VIRIAL_INOUT(6), Q_OUT(:)
  ...
  CALL LATTE(NTYPES, TYPES, COORDS, MASSES, XLO, XHI, XY, XZ, YZ, FORCES, &
       MAXITER, VENERG, VEL, DT, VIRIAL_INOUT, Q_OUT, NEWSYSTEM, EXISTERROR)
