...
!!
FUNCTION LATTE_COMPUTE_OLD(NATS, NTYPES, COORDS_IN, LATTICEVECTORS_IN, ATOMTYPES_IN, ATOMICNUMBERS_IN,&
     &FIELD_IN, CHARGES_OUT, FORCES_OUT, DIPOLE_OUT, ENERGY_OUT, VERB_IN) RESULT(ERR) BIND(C, NAME='latte_compute_old')
  USE LATTE_LIB
  ...
  CALL COMPUTE_OLD(COORDS, ATOMTYPES, ATOMICNUMBERS, LATTICEVECTORS,&
...
END FUNCTION LATTE_COMPUTE_OLD
...
!! \param verb_in Verbosity level.
!!
FUNCTION LATTE_COMPUTE_ALL(NORBS, NATS, NTYPES, COORDS_IN, LATTICEVECTORS_IN, ATOMTYPES_IN, ATOMICNUMBERS_IN,&
     &FIELD_IN, HAM_OUT, OVER_OUT, DM_OUT, CHARGES_OUT, VERB_IN, NEWSYSTEM_IN) RESULT(ERR) BIND(C, NAME='latte_compute_all')
  USE LATTE_LIB
  USE ISO_C_BINDING, ONLY: C_CHAR, C_DOUBLE, C_INT, C_BOOL
  ...
  INTEGER(C_INT), INTENT(INOUT) :: ATOMICNUMBERS_IN(NTYPES)
  REAL(C_DOUBLE), INTENT(INOUT) :: LATTICEVECTORS_IN(9)
  INTEGER(C_INT), INTENT(IN), VALUE :: VERB_IN, NEWSYSTEM_IN
  LOGICAL(C_BOOL) :: ERR

  REAL(DP), ALLOCATABLE :: COORDS(:, :)
  REAL(DP), ALLOCATABLE :: HAM(:, :), OVER(:, :), DM(:, :)
  REAL(DP), ALLOCATABLE :: FIELD(:)
  ...
  CALL COMPUTE_ALL(COORDS, ATOMTYPES, ATOMICNUMBERS, LATTICEVECTORS,&
       &FIELD, HAM, OVER, DM, CHARGES, VERB, NEWSYSTEM_IN)
...
END FUNCTION LATTE_COMPUTE_ALL
...
!!
FUNCTION LATTE_COMPUTE(COMPFLAG_IN, SY_IDX, NUM_SY, NORBS, NCORES, NCOREATOMS, NATS, NTYPES, CHEMPOT_IN, COULOMBV_IN, COORDS_IN, LATTICEVECTORS_IN, ATOMTYPES_IN, ATOMICNUMBERS_IN,&
  & HAM_OUT, OVER_OUT, DM_OUT, CHARGES_OUT, EVALS_OUT, DVALS_OUT, ENERGY_OUT, FORCES_OUT, VERB_IN, NEWSYSTEM_IN, KEEPMEM_IN) RESULT(ERR) BIND(C, NAME='latte_compute')
USE LATTE_LIB
USE ISO_C_BINDING, ONLY: C_CHAR, C_DOUBLE, C_INT, C_BOOL
...
DO K = 1, NATS !We correct for the indexing
 ATOMTYPES(K) = ATOMTYPES_IN(K) + 1
END DO
CALL COMPUTE(COMPFLAG_IN, SY_IDX, NUM_SY, NCORES, NCOREATOMS, CHEMPOT_IN, COULOMBV, COORDS, ATOMTYPES, ATOMICNUMBERS, LATTICEVECTORS,&
    & HAM, OVER, DM, CHARGES, EVALS, DVALS, ENERGY, FORCES, VERB_IN, NEWSYSTEM_IN, KEEPMEM_IN, ERR_STATUS)
