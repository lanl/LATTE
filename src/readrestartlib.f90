...
SUBROUTINE READRESTARTLIB(ITER)
  ...
  INTEGER :: CHARACTERCHECK(9),COMPLEXCHECK(15),INTEGERCHECK(20),REALCHECK(98)
  INTEGER :: CHECK(25)
  ...
  IF(INTEGERCHECK( 7 ) == 1)THEN
     READ(14) DUMMYN ,DUMMYN1 ,DUMMYN2
     IF(.NOT.ALLOCATED( NEBCOUL )) ALLOCATE( NEBCOUL (DUMMYN,DUMMYN1,DUMMYN2))
     READ(14) NEBCOUL
  ENDIF

  IF(INTEGERCHECK( 8 ) == 1)THEN
     READ(14) DUMMYN ,DUMMYN1 ,DUMMYN2
     IF(.NOT.ALLOCATED( NEBPP )) ALLOCATE( NEBPP (DUMMYN,DUMMYN1,DUMMYN2))
     READ(14) NEBPP
  ENDIF

  IF(INTEGERCHECK( 9 ) == 1)THEN
     READ(14) DUMMYN ,DUMMYN1 ,DUMMYN2
     IF(.NOT.ALLOCATED( NEBTB )) ALLOCATE( NEBTB (DUMMYN,DUMMYN1,DUMMYN2))
     READ(14) NEBTB
  ENDIF
