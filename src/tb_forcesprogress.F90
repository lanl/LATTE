...
SUBROUTINE TBFORCESPROGRESS
  ...
  IF (SPINON .EQ. 0) THEN
     ...
     IF (KBT .GT. 0.0000001) THEN
        ...
        CALL BML_MULTIPLY(ZMAT_BML,ZMAT_BML,AUX_BML,1.0_dp,0.0_dp,LT%THRESHOLD)
        ...
        CALL BML_MULTIPLY(AUX1_BML,RHO_BML,AUX_BML,1.0_dp,0.0_dp,LT%THRESHOLD)
     ...
     ELSE
        ...
        CALL BML_MULTIPLY(RHO_BML,HAM_BML,AUX1_BML,1.0_dp,0.0_dp,LT%THRESHOLD)

        CALL BML_MULTIPLY(AUX1_BML,RHO_BML,AUX_BML,0.5_dp,0.0_dp,LT%THRESHOLD)
  ...
  ELSE
     ...
     ELSE
        ...
        CALL BML_MULTIPLY(RHODN_BML,HAMDN_BML,AUX_BML,1.0_dp,1.0_dp,LT%THRESHOLD)
