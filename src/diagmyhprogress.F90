...
SUBROUTINE DIAGMYHPRG()
  ...
  IF (SPINON .EQ. 0) THEN
     ...
     IF(BML_GET_N(EVECS_BML) > 0) CALL BML_ZERO_MATRIX(BML_MATRIX_DENSE, BML_ELEMENT_REAL, &
     ...
     IF (DOKERNEL .OR. DFTBU) CALL BML_EXPORT_TO_DENSE(ORTHOH_BML, ORTHOH)
