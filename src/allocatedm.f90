...
!  USE SPINARRAY
  ...
  ALLOCATE(PO_0(HDIM,HDIM), PO_1(HDIM,HDIM), PO_2(HDIM,HDIM), PO_3(HDIM,HDIM))
  ...
  ALLOCATE(H_INDEX_START(NATS), H_INDEX_END(NATS), DELTAQDM(NATS), DFTB_U(NATS))
  ALLOCATE(PS(HDIM,HDIM), SU(HDIM,HDIM), Delta_DS(HDIM,HDIM))
  ALLOCATE(HubForce(3,NATS))
