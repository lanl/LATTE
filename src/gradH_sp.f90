...
SUBROUTINE GRADHSP
  ...
  !$OMP PRIVATE(RIJ, DC, MAGR, INVR, SCLGSP, DGSPDR, FTMP) &
              ...
              DO K = 1, NOINT
                 IF ((ATELE(I) .EQ. ELE1(K) .AND. &
                    ...
                    IF (BTYPE(K) .EQ. "sss") THEN
                       ...
                       CALL DUNIVSCALE_SUB(MAGR, BOND(:,K), DC, HSSS, DSSSDR)
              ...
              DO K = 1, NOINT
                 ...
                 IF ((ATELE(I) .EQ. ELE1(K) .AND. &
                    ...
                    ELSEIF (BTYPE(K) .EQ. "sps") THEN
                       ...
                       CALL DUNIVSCALE_SUB(MAGR, BOND(:,K), DC, HSPS, DSPSDR)
              ...
              DO K = 1, NOINT
                 ...
                 IF ((ATELE(I) .EQ. ELE1(K) .AND. &
                    ...
                    ELSEIF (BTYPE(K) .EQ. "sps") THEN
                       ...
                       CALL DUNIVSCALE_SUB(MAGR, BOND(:,K), DC, HPSS, DPSSDR)
                 ...
                 DO K = 1, NOINT
                    ...
                    IF (ATELE(I) .EQ. ELE1(K) .AND. &
                       ...
                       ELSEIF (BTYPE(K) .EQ. "pps") THEN
                          ...
                          CALL DUNIVSCALE_SUB(MAGR, BOND(:,K), DC, HPPS, DPPSDR)

                       ELSEIF (BTYPE(K) .EQ. "ppp") THEN

                          CALL DUNIVSCALE_SUB(MAGR, BOND(:,K), DC, HPPP, DPPPDR)
