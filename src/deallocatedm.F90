...
!  USE SPINARRAY
  ...
  IF(KON .EQ. 0) THEN
    ...
    CALL BML_DEALLOCATE(DO_BML)
    CALL BML_DEALLOCATE(DO_BML_OLD)
    CALL BML_DEALLOCATE(PO_BML)
    CALL BML_DEALLOCATE(PO0_BML)
    CALL BML_DEALLOCATE(PO1_BML)
    CALL BML_DEALLOCATE(PO2_BML)
    CALL BML_DEALLOCATE(PO3_BML)
    CALL BML_DEALLOCATE(PO4_BML)
    CALL BML_DEALLOCATE(PO5_BML)
    CALL BML_DEALLOCATE(PO6_BML)
    CALL BML_DEALLOCATE(D2P_BML)
#endif
  ELSE
    DEALLOCATE(SUK, HK_U, XK, YK, HUK, PSK)
    DEALLOCATE(UDK,UPSDK,PSUDK,AHUBK)
    DEALLOCATE(DORK,DORK_OLD)
  ENDIF
