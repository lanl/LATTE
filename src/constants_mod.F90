...
MODULE CONSTANTS_MOD
  ...
  INTEGER :: GRAPHON ! turn on GRAPH SOLVER (require QMD-progress)
  INTEGER :: GRAPH_NPARTS ! number of parts for graph solver
  INTEGER :: NSPIN
  INTEGER :: ORDERNMOL
  ...
  INTEGER :: COMPFLAG, KEEPMEM 
  INTEGER :: NCORES, NCOREATOMS
  INTEGER, PARAMETER :: NUM_ATOMTYPES = 7 

  !INTEGER, PARAMETER :: ATOMIC_NUMBERS(NUM_ATOMTYPES) = [1, 6, 7, 8, 9, 16, 17]
  CHARACTER(LEN=2), PARAMETER :: ATOMTYPES(NUM_ATOMTYPES) = [CHARACTER(LEN=2) :: "H", "C", "N", "O", "F", "S", "Cl"]
