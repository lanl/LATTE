...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  SUBROUTINE dP2MD(PITER)  !! ANDERS CHANGE NEW SUBROUTINE
    IMPLICIT NONE
    INTEGER, INTENT(IN) :: PITER
    !
...
!
  SUBROUTINE dP2MIXER(PITER,SCF_ERR,MAXDQ)  !! ANDERS CHANGE NEW SUBROUTINE
    IMPLICIT NONE
    INTEGER, INTENT(IN) :: PITER
...
!
  ...
  SUBROUTINE dP2(Delta_DO,dP)  !! ANDERS CHANGE NEW SUBROUTINE
    IMPLICIT NONE
